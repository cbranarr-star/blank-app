...
st.set_page_config(page_title="Portafolio Profesional - Cristian Camilo Bran Arriaga", layout="wide")
...
# CSS personalizado para efectos de movimiento
st.markdown("""
<style>
    .card {
...
experiencias = [
    ("Savia Salud EPS", "Practicante de infraestructura y Agente mesa de servicios. Soporte nivel 1/2, gestión de tickets, monitoreo de red y optimización de plataformas de salud."),
...
# Footer
st.markdown("---")
st.write("📍 Medellín, Colombia | 📞 314 613 9747 | 📧 ccbran1998@hotmail.com")
